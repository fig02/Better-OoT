...
def patch_rom(world, rom):
    ...
    rom.write_bytes(0x021A072C, [0x0F, 0x22]) #change requiem time cs to set time to A60C instead of 8000
    ...
    #rom.write_bytes(0xCA3530, [0x00, 0x00, 0x00, 0x00]) #ruto text
    ...
    # Speed obtaining Fairy Ocarina (rando 1.0)
    ...
    """
    """
    # Forbid Suns Song from a bunch of cutscenes
    ...
    write_bytes_to_save(0x0C, [0x80,0x00]) #no hyrule field with owls
    ...
    """
    #! ADD TOGGLE ALONG WITH OTHER OWLS
...
chestTypeMap = {
    ...
    0xA000: [0xA000, 0xA000, 0xA000], #Large, Appears, Suns Song Triggered
