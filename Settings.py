...
class Setting_Info:
    ...
    def __init__(self, name, type, bitwidth=0, shared=False, args_params=None, gui_params=None):
...
class Setting_Widget(Setting_Info):
    ...
    def __init__(self, name, type, choices, default, args_params=None,
    ...
    Setting_Info('navisfxoverworld', str, 0, False,
                 {
                     ...
                     'const': 'Default',
                     'nargs': '?',
                     'choices': ['Default', 'Notification', 'Rupee', 'Timer', 'Tamborine', 'Recovery Heart',
                                 'Carrot Refill', 'Navi - Hey!', 'Navi - Random', 'Zelda - Gasp', 'Cluck', 'Mweep!',
                                 'Random', 'None'],
                     'help': '''\
    ...
    Setting_Info('healthSFX', str, 0, False,
                 {
                     ...
                     'const': 'Default',
                     'nargs': '?',
                     'choices': ['Default', 'Softer Beep', 'Rupee', 'Timer', 'Tamborine', 'Recovery Heart',
                                 'Carrot Refill', 'Navi - Hey!', 'Zelda - Gasp', 'Cluck', 'Mweep!', 'Random', 'None'],
                     'help': '''\
...
def get_settings_from_command_line_args():
    ...
    parser.add_argument('--settings_string',
                        help='Provide sharable settings using a settings string. This will override all flags that it specifies.')
